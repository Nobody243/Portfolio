  ...
  return (
    <>
      ...
      */}
      ...
      {/* Gated on the measured bounds, not merely on the bucket: the exclusion
          shell needs the real bbox or it silently no-ops. */}
      {measured ? (
        <ParticleField bucket={bucket} bounds={measured.bounds} />
      ) : null}
